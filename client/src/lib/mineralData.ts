...
const baseMinerals: MineralBase[] = [
  ...
  { id: "allanite", name: "Allanite group", formula: "(Ca,Ce,La,Nd,Y)₂(Al,Fe)₃(Si₂O₇)(SiO₄)O(OH)", family: "silicate", elements: ["Al", "Ca", "Ce", "Fe", "H", "La", "Nd", "O", "Si", "Y"], note: "A rare-earth-rich member of the epidote supergroup.", sourceName: "WGNHS", sourceUrl: "https://home.wgnhs.wisc.edu/allanite/" },
  ...
  { id: "lepidolite", name: "Lepidolite", formula: "K(Li,Al)₃(Si,Al)₄O₁₀(F,OH)₂", family: "silicate", elements: ["K", "Li", "Al", "Si", "O", "F", "H"], note: "A lithium-rich mica common in rare-element pegmatites.", sourceName: "Webmineral", sourceUrl: "https://webmineral.com/data/Lepidolite.shtml" },
  { id: "pollucite", name: "Pollucite", formula: "(Cs,Na)₂Al₂Si₄O₁₂·2H₂O", family: "silicate", elements: ["Cs", "Na", "Al", "Si", "O", "H"], note: "A cesium-rich zeolite found in rare-element pegmatites.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-3255.html" },
  ...
  { id: "xenotime", name: "Xenotime-(Y)", formula: "YPO₄", family: "phosphate", elements: ["Y", "P", "O"], note: "A yttrium phosphate common as an accessory mineral in igneous rocks.", sourceName: "Webmineral", sourceUrl: "http://webmineral.com/data/Xenotime-(Y).shtml" },
];
