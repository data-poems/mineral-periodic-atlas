...
const baseMinerals: MineralBase[] = [
  ...
  { id: "olivine", name: "Olivine series", formula: "(Mg,Fe)₂SiO₄", family: "silicate", recordKind: "series", elements: ["Si", "O"], substitutes: ["Mg", "Fe"], occupancyNote: "The metal sites contain Mg, Fe, or both; neither metal is required throughout the series.", note: "A magnesium–iron solid-solution series." },
  ...
  { id: "pyrite", name: "Pyrite", formula: "FeS₂", family: "sulfide", elements: ["Fe", "S"], note: "A widespread iron sulfide known as fool’s gold.", locality: "Navajún, La Rioja", country: "Spain", localityContext: "World-famous for sharply formed cubic pyrite crystals.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-3314.html", image: "/specimens/pyrite.jpg", imageAlt: "Metallic golden pyrite crystal specimen", imageCredit: "James St. John", imageLicense: "CC BY 2.0", imageLicenseUrl: "https://creativecommons.org/licenses/by/2.0/", imageOrigin: "See the original photograph", imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Pyrite_(18858891699).jpg" },
  ...
  { id: "galena", name: "Galena", formula: "PbS", family: "sulfide", elements: ["Pb", "S"], note: "The principal ore mineral of lead.", locality: "Viburnum Trend, Missouri", country: "United States", localityContext: "A major lead district noted for galena specimens.", sourceName: "USGS", sourceUrl: "https://www.usgs.gov/media/images/galena-specimen", image: "/specimens/galena.jpg", imageAlt: "Metallic gray galena specimen", imageCredit: "USGS / Mineral Information Institute", imageLicense: "Public domain in the US", imageLicenseUrl: "https://commons.wikimedia.org/wiki/File:Galena.jpg", imageOrigin: "Not specified by the source", imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Galena.jpg" },
  ...
  { id: "hematite", name: "Hematite", formula: "Fe₂O₃", family: "oxide", elements: ["Fe", "O"], note: "A major iron ore and common red pigment mineral.", locality: "Minas Gerais", country: "Brazil", localityContext: "A classic district for lustrous iron-rose hematite.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-1856.html", image: "/specimens/hematite.jpg", imageAlt: "Dark metallic hematite crystal specimen", imageCredit: "DanielCD", imageLicense: "CC BY-SA 3.0", imageLicenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/", imageOrigin: "Michigan, United States", imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Hematite.jpg" },
  ...
  { id: "fluorite", name: "Fluorite", formula: "CaF₂", family: "halide", elements: ["Ca", "F"], note: "A calcium fluoride known for vivid colors.", locality: "Weardale, County Durham", country: "United Kingdom", localityContext: "A celebrated source of purple and green fluorite crystals.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-1576.html", image: "/specimens/fluorite.jpg", imageAlt: "Purple fluorite crystals", imageCredit: "Gia.cossa", imageLicense: "CC BY-SA 2.5", imageLicenseUrl: "https://creativecommons.org/licenses/by-sa/2.5/", imageOrigin: "Camissinone Mine, Zogno, Italy", imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Fluorite.jpg" },
  ...
  { id: "tourmaline", name: "Tourmaline group", formula: "XY₃Z₆(T₆O₁₈)(BO₃)₃V₃W", family: "silicate", recordKind: "group", elements: ["B", "Si", "O"], substitutes: ["Al", "Na", "Ca", "Li", "Mg", "Fe", "Mn", "Cr", "Ti", "F", "H", "K"], occupancyNote: "Metal-site occupants vary across this borosilicate group; the list shows selected common possibilities, not every permitted composition.", note: "A chemically variable borosilicate group. V and W in the general formula are anion sites (O, OH, F), not vanadium or tungsten.", locality: "Island of Elba", country: "Italy", localityContext: "The classic locality that gave the tourmaline species elbaite its name.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-4003.html" },
  ...
  { id: "monazite", name: "Monazite group", formula: "REEPO₄", family: "phosphate", recordKind: "group", elements: ["P", "O"], substitutes: ["Ce", "La", "Nd", "Sm", "Gd"], occupancyNote: "A rare-earth element occupies the metal site; Ce is common but is not required in every member represented here.", note: "A rare-earth phosphate whose uranium and thorium content supports geochronology. Ce is the common end-member; other REE occupy the same site.", locality: "Ilmen Nature Reserve, Chelyabinsk", country: "Russia", localityContext: "The type locality of monazite-(Ce), the group’s most common member.", sourceName: "Mindat", sourceUrl: "https://www.mindat.org/min-2750.html" },
